...
const  intVector PARAM_OPT_ORDER_MODELTEST = {CORAX_OPT_PARAM_BRANCHES_ITERATIVE, CORAX_OPT_PARAM_PINV,
                                              ...
                                              CORAX_OPT_PARAM_SUBST_RATES, CORAX_OPT_PARAM_FREE_RATES };
...
double TreeInfo::optimize_params(int params_to_optimize, double lh_epsilon)
{
  ...
  for (auto param: !_param_opt_order.empty() ? _param_opt_order : PARAM_OPT_ORDER_DEFAULT)
  {
    switch (param)
    {
      case CORAX_OPT_PARAM_SUBST_RATES:
        ...
        break;
      case CORAX_OPT_PARAM_FREQUENCIES:
        /* optimize BASE FREQS */
      ...
      case CORAX_OPT_PARAM_FREE_RATES:
        ...
        break;
      case CORAX_OPT_PARAM_BRANCHES_ITERATIVE:
        /* optimize BRLEN */
